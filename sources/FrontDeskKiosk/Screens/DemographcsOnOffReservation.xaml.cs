...
{
    public partial class DemographicsOnOffReservation : UserControl, IVisualScreen, IDemographicsLookupVisualScreen
    {

        private DemographicsLookupValuesControlBehavior _behavior;


        public DemographicsOnOffReservation()
        {
            InitializeComponent();
        ...
        public DemographicsLookupServiceBase LookupService => new DemographicsLivingOnReservationService();
