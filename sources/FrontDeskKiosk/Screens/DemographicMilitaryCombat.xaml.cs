...
{
    public partial class DemographicsMilitaryCombat : UserControl, IVisualScreen, IDemographicsLookupVisualScreen
    {

        private DemographicsLookupValuesControlBehavior _behavior;


        public DemographicsMilitaryCombat()
        {
            InitializeComponent();
        ...
        public DemographicsLookupServiceBase LookupService => new DemographicsMilitaryCombatService();
