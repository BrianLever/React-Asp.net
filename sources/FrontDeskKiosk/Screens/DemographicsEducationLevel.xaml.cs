...
{
    public partial class DemographicsEducationLevel : UserControl, IVisualScreen, IDemographicsLookupVisualScreen
    {
        private DemographicsLookupValuesControlBehavior _behavior;

        public DemographicsEducationLevel()
        {
            InitializeComponent();
        ...
        public DemographicsLookupServiceBase LookupService => new DemographicsEducationLevelService();
