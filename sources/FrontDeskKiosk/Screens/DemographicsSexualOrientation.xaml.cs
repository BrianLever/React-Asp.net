...
{
    public partial class DemographicsSexualOrientation : UserControl, IVisualScreen, IDemographicsLookupVisualScreen
    {
        private DemographicsLookupValuesControlBehavior _behavior;

        public DemographicsSexualOrientation()
        {
            InitializeComponent();
        ...
        public DemographicsLookupServiceBase LookupService => new DemographicsSexualOrientationService();
