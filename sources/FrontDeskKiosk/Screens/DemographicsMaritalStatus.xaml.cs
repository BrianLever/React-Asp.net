...
namespace FrontDesk.Kiosk.Screens
{
    ...
    public partial class DemographicsMaritalStatus : UserControl, IVisualScreen, IDemographicsLookupVisualScreen
    {
        private DemographicsLookupValuesControlBehavior _behavior;

        public DemographicsMaritalStatus()
        {
            InitializeComponent();
        ...
        public DemographicsLookupServiceBase LookupService => new DemographicsMaritalStatusService();
