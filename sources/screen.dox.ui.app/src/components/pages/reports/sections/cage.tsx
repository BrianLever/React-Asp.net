...
const Cagesection = (): React.ReactElement => {
    ...
    if(!reportListByAge['AlcoholSection']) {
        return <></>;
    }

    if((!reportListByAge['AlcoholSection']['Items'].length && !reportListByAge['AlcoholSection']['MainQuestions'].length)) {
        return <></>;
    }
    ...
    return (
      <TableContainer>
        ...
        <TableHead className={customClasss.tableHead}>
          <TableRow>
            <TableCell width={'50%'}><ReportHeaderText>{reportListByAge['AlcoholSection']['Header']}</ReportHeaderText></TableCell>
        ...
        <TableBody>
        {(typeof(reportListByAge['AlcoholSection']['MainQuestions']) !== "undefined") && reportListByAge['AlcoholSection']['MainQuestions'].length != 0 &&
          reportListByAge['AlcoholSection']['MainQuestions'].map((item: any) => 
            (<TableRow>
        ...
        {(typeof(reportListByAge['AlcoholSection']['Items']) !== 'undefined') && reportListByAge['AlcoholSection']['Items'].length !== 0 &&
          reportListByAge['AlcoholSection']['Items'].map((item: any) => 
            (<TableRow>
              <TableCell>
