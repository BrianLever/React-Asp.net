...
import { manageUsersLocationsSelector , manageUsersLocationIdSelector, manageUsersUserSelector, manageUsersGroupsSelector } from '../../../../selectors/manage-users';
...
const CreateUser = (): React.ReactElement => {
  ...
  return (
      <div className={'create-user'} style={{ fontSize: 16 }}>
        <Grid container spacing={2}>
           ...
           <Grid item sm={4}>
                <ProfileLargeBoldText>Confirm Password*</ProfileLargeBoldText>
                <TextField
                    fullWidth
                    margin="dense"
                    id="confirm-password"
