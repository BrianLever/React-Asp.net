...
import { reportsIndicateReportTypeArray, getLocationListActionRequest, 
    ...
    setReportsCurrentStartDate, setReportsCurrentEndDate,setReportBSRReportType,resetReportsSearchParametersRequest,postFilteredDrugByAgeRequest, resetDrugsByAgeSearchParametersRequest
} from '../../../../actions/reports';
import postDrugByAgePrint from '../../../../api/calls/post-drug-by-age-print';
...
const DrugByAgeTemplate = (): React.ReactElement => {
    ...
    return (
        <ContainerBlock>
            <Grid container spacing={1} >
                ...
                <ReportDropDownMenu name={'Drug Use Type'}/>
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => dispatch(postFilteredDrugByAgeRequest())}
                    >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            dispatch(resetDrugsByAgeSearchParametersRequest());
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            try {
                                postDrugByAgePrint(prepareFilterProps()).then(data => {
...
export default DrugByAgeTemplate;
