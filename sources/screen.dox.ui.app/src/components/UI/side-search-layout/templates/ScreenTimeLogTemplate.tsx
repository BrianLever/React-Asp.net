...
import {getLocationListActionRequest, 
    ...
    setReportsCurrentStartDate, setReportsCurrentEndDate,postFilteredScreenTimeLogRequest, resetScreenTimeLogSearchParametersRequest
} from '../../../../actions/reports';
import postScreenTimeLogPrint from '../../../../api/calls/post-print-screen-time-log';
...
const ScreenTimeLogTemplate = (): React.ReactElement => {
            ...
            <Grid container spacing={1} >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => dispatch(postFilteredScreenTimeLogRequest())}
                    >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            dispatch(resetScreenTimeLogSearchParametersRequest());
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            try {
                                postScreenTimeLogPrint(prepareFilterProps()).then(data => {
...
export default ScreenTimeLogTemplate;
