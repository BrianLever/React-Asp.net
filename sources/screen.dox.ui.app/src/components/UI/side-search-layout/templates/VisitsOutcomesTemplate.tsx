...
import { reportsIndicateReportTypeArray, getLocationListActionRequest, 
    ...
    setReportsCurrentStartDate, setReportsCurrentEndDate,setReportBSRReportType,postFilteredVisitsOutcomesRequest,resetVisitsOutcomesSearchParametersRequest
} from '../../../../actions/reports';
import postVisitsOutcomesPrint from '../../../../api/calls/post-print-visits-outcomes';
...
const VisitsOutcomesTemplate = (): React.ReactElement => {
            ...
            <Grid container spacing={1} >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => dispatch(postFilteredVisitsOutcomesRequest())}
                    >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            dispatch(resetVisitsOutcomesSearchParametersRequest());
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            try {
                                postVisitsOutcomesPrint(prepareFilterProps()).then(data => {
...
export default VisitsOutcomesTemplate;
