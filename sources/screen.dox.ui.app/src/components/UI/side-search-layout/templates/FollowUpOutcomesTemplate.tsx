...
import { reportsIndicateReportTypeArray, getLocationListActionRequest, 
    ...
    setReportsCurrentStartDate, setReportsCurrentEndDate,setReportBSRReportType, resetFollowupOutcomesSearchParametersRequest, postFilteredFollowupOutcomesRequest
} from '../../../../actions/reports';
import postFollowupOutcomesPrint from '../../../../api/calls/post-print-followup-outcomes';
...
const FollowupOutcomesTemplate = (): React.ReactElement => {
    ...
    return (
        <ContainerBlock>
            <Grid container spacing={1} >
                ...
                <ReportDropDownMenu name={'Follow-Up Outcomes'}/>
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => dispatch(postFilteredFollowupOutcomesRequest())}
                    >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            dispatch(resetFollowupOutcomesSearchParametersRequest());
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            try {
                                postFollowupOutcomesPrint(prepareFilterProps()).then(data => {
...
export default FollowupOutcomesTemplate;
