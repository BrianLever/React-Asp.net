...
import { reportsIndicateReportTypeArray, getLocationListActionRequest, 
    setReportsLocationsId, setReportsCurrentGPRAPeriodRangeChange,
    setReportsCurrentStartDate, setReportsCurrentEndDate,setReportBSRReportType,resetReportsSearchParametersRequest,postFilteredDrugByAgeRequest, resetDrugsByAgeSearchParametersRequest, postFilteredPatientDemographicsRequest, resetPatientDemographicsSearchParametersRequest
} from '../../../../actions/reports';
import postPatientDemographicsPrint from '../../../../api/calls/post-print-patient-demographics';
...
const PatientDemographicsTemplate = (): React.ReactElement => {
    ...
    return (
        <ContainerBlock>
            <Grid container spacing={1} >
                ...
                <ReportDropDownMenu  name={'Patient Demographics'}/>
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => dispatch(postFilteredPatientDemographicsRequest())}
                    >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            dispatch(resetPatientDemographicsSearchParametersRequest());
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            try {
                                postPatientDemographicsPrint(prepareFilterProps()).then(data => {
...
export default PatientDemographicsTemplate;
