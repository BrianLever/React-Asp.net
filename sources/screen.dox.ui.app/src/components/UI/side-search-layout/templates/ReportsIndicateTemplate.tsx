...
import { reportsIndicateReportTypeArray,resetReportsSearchParametersRequest,setReportsCurrentStartDate,setReportsCurrentEndDate,getLocationListActionRequest,
        setReportsCurrentGPRAPeriodRangeChange,setReportBSRReportType,setReportsLocationsId,postFilteredReportsRequest, reportEarliestDateRequest, reportGPRAPeriodsRequest,
 } from '../../../../actions/reports';
import postReportByProblemPrint from '../../../../api/calls/post-report-by-problem-print';
import { 
    ...
    getReportBsrReportTypeSelector,isReportLoadingSelector, getEarliestDateSelector, getReportGrpaPeriodsSelector
...
const ReportsIndicateTemplate = (): React.ReactElement => {

    const dispatch = useDispatch();
    React.useEffect(() => {
        dispatch(reportEarliestDateRequest());
        dispatch(reportGPRAPeriodsRequest());
    }, [])
    ...
    return (
        <ContainerBlock>
            <Grid container spacing={1} >
                ...
                <ReportDropDownMenu name={'Screening Results by Problem'}/>
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => dispatch(postFilteredReportsRequest())}
                    >
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {                           
                            dispatch(resetReportsSearchParametersRequest());
                ...
                <Grid item xs={12} style={{ textAlign: 'center' }}>
                    <Button 
                        ...
                        onClick={() => {
                            try {
                                postReportByProblemPrint(prepareFilterProps()).then(data => {console.log(data);
...
export default ReportsIndicateTemplate;
