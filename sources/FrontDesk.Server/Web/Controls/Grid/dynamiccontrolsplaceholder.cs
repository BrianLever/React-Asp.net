...
namespace FrontDesk.Server.Web.Controls
{
	...
	internal class DynamicControlsPlaceholder : PlaceHolder
	{
	...
	internal enum HandleDynamicControls
	{
		/// <summary>
	...
	[Serializable]
    [Obfuscation(Feature = "renaming", Exclude = true)]
	internal delegate void DynamicControlEventHandler(object sender, DynamicControlEventArgs e);

	/// <summary>
	/// Provides data for the ControlRestored event
	/// </summary>
    [Obfuscation(Feature = "renaming", Exclude = true, ApplyToMembers = true)]
	internal class DynamicControlEventArgs : EventArgs
	{
