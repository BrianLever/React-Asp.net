...
{
	public class ProblemGamblingBhsPdfReportSection : BhsPdfReportSectionBase
	{
		public ProblemGamblingBhsPdfReportSection(PdfReport report) : base(report)
		{
		}

		public override string ScreeningSectionID { get { return ScreeningSectionDescriptor.ProblemGambling; } }
		...
		protected void RenderMainQuestionContentTable(PdfPTable containerTable)
		{
			...
			foreach (var questionInfo in questionList)
			{
				...
				questionInfo.QuestionText = (questionInfo.PreambleText + " " + questionInfo.QuestionText).TrimStart();
