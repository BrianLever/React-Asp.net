...
{
    public class DrugsOfChoiceByAgePdfReport : BhsIndicatorPdfReportBase<IndicatorReportByAgeViewModel>
    {
        ...
        #region constructor
        public DrugsOfChoiceByAgePdfReport(
             ...
             : base(filter, uniquePatientsReportType)
        {
            ...
            Model = _indicatorReportService.GetDrugsOfChoiceByAge(ScreeningInfo, filter, _ageGroupsProvider.AgeGroups, UniquePatientsReportType);
        ...
        public override void PrintReport()
        {
            ...
            PrintHeader(document, new string[] { "Behavioral Health Indicator Report", "Drug Use Results by Age" });
            //Print report settings
            PrintReportSettings(document);

            PrintScoreSection(document, Model.DrugOfChoicePrimaryAnswers, 0);
            PrintScoreSection(document, Model.DrugOfChoiceSecondaryAnswers, 0);
            PrintScoreSection(document, Model.DrugOfChoiceTertiaryAnswers, 0);
