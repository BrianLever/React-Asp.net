IF OBJECT_ID('[dbo].[fn_GetUniquePatientScreenings]') IS NOT NULL
    DROP FUNCTION [dbo].[fn_GetUniquePatientScreenings]
go
...
-------------------
IF OBJECT_ID('[dbo].[uspGetUniquePatientScreeningResultsForExcelExport]') IS NOT NULL
    DROP PROC [dbo].[uspGetUniquePatientScreeningResultsForExcelExport]
go

CREATE PROCEDURE [dbo].[uspGetUniquePatientScreeningResultsForExcelExport]
    @StartDate DateTimeOffset,
    @EndDate DateTimeOffset,
    @LocationID int  = NULL
AS
...
------------------------------------
IF OBJECT_ID('[dbo].[uspGetUniqueDrugsOfChoiceScreeningsResultsForExcelExport]') IS NOT NULL
    DROP PROC [dbo].[uspGetUniqueDrugsOfChoiceScreeningsResultsForExcelExport]
go
...
--------------------------------
IF OBJECT_ID('[dbo].[uspGetUniquePatientCombinedResultsForExcelExport]') IS NOT NULL
    DROP PROC [dbo].[uspGetUniquePatientCombinedResultsForExcelExport]
go
...
IF NOT EXISTS(SELECT 1 FROM dbo.DbVersion WHERE DbVersion =  '10.0.1.1')
INSERT INTO dbo.DbVersion(DbVersion) VALUES('10.0.1.1');