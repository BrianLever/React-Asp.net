...
namespace FrontDesk.Server.LicenseManagerWeb
{
    ...
    /// </summary>
    public abstract class LMBaseManagementWebForm<TFormObject, TFormObjectID> : LMBaseWebForm
        ...
        where TFormObjectID : IEquatable<TFormObjectID>
    {
        ...
        /// Default constructor
        /// </summary>
        public LMBaseManagementWebForm()
        {
        }
        ...
        public override bool IsNewInstance
        {
            get
            {
                return (this.formObjectID.Equals(default(TFormObjectID)) || this.curFormObject == null);
            }
        }
        /// <summary>
        ...
        {
            if (!this.formObjectID.Equals(default(TFormObjectID)) && curFormObject == null)
            {
