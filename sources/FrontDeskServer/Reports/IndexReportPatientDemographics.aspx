<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true"
    CodeFile="IndexReportPatientDemographics.aspx.cs" Inherits="IndexReportPatientDemographicsPage" EnableEventValidation="false" %>

<%@ Register Src="~/controls/Report/BHIPatientDemographics.ascx" TagName="IndexReport" TagPrefix="uc" %>
