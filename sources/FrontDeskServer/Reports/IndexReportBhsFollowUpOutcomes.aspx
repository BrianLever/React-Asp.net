<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true"
    CodeFile="IndexReportBhsFollowUpOutcomes.aspx.cs" Inherits="IndexReportBhsFollowUpOutcomesPage" EnableEventValidation="false" %>

<%@ Register Src="~/controls/Report/BHIBhsFollowUpOutcomes.ascx" TagName="IndexReport" TagPrefix="uc" %>
