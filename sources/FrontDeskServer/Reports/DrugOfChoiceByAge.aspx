<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true"
    CodeFile="DrugOfChoiceByAge.aspx.cs" Inherits="DrugOfChoiceReportByAge" EnableEventValidation="false" %>

<%@ Register Src="~/controls/Report/BHIDrugOfChoiceReportByAge.ascx" TagName="IndexReport" TagPrefix="uc" %>
