<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BhsVisitList.ascx.cs" Inherits="controls_BhsVisitList"
        ...
        <div class="check-in">
            <cc:HierarDynamicGrid runat="server" ID="grvList" DataSourceID="odsList" AllowPaging="true"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Screening Date" SortExpression="LastCreatedDate">
                        <HeaderStyle CssClass="w15 r" />
                        <ItemStyle CssClass="r" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="File Completion Date">
                        <HeaderStyle CssClass="w15 r" />
                        <ItemStyle CssClass="r" />
                    </asp:BoundField>
                            ...
                            <tr>
                                ...
                                <td class="w50 l">
                                    <asp:HyperLink runat="server" NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "DetailsPageUrl") %>'
                                        ...
                                        EnableViewState="false" CssClass='<%#DataBinder.Eval(Container.DataItem, "IsDemographicCssClass") %>'></asp:HyperLink>
                                </td>
                                ...
                                <td class="r w15">
                                    <asp:Literal runat="server" ID="ltrLocation" Text='<%# DataBinder.Eval(Container.DataItem, "LocationName")%>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
