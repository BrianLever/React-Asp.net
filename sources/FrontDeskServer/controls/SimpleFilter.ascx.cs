...
using FrontDesk.Server.Web.Controls;
    ...
    public partial class SimpleFilterCtrl : BaseUserControl
    {
       ...
       Category("Data")]
        ...
        protected void Clear_Click(object sender, EventArgs e)
        {
            ...
            SetControlValue();
            Page.AddAjaxScriptStatement(Page.GetControlClearStateScript(txtValue.ClientID, FrontDesk.Server.Web.HTMLControlType.Textbox, ""));
