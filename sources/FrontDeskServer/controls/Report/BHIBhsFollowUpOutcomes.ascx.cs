...
namespace FrontDesk.Server.Web.Controls
{
    ...
    public partial class BHIBhsFollowUpOutcomesControl : BHIReportByAgeBase
    {
        ...
        public BhsFollowUpOutcomesViewModel model = null;
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            ctrlPatientAttendedVisit.Model = model.PatientAttendedVisit;
            ctrlFollowUpContactOutcome.Model = model.FollowUpContactOutcome;
        ...
        protected void BindReportData()
        {
            if (EndDate != null)
            {
                ...
                model = _indicatorReportService.GetOutcomesReportByAge(
                    filter,
