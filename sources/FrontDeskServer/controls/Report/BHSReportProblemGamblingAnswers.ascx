<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BHSReportProblemGamblingAnswers.ascx.cs"
    Inherits="FrontDesk.Server.Web.Controls.BHSReportProblemGamblingAnswersControl" %>
<div class="group section gambling">
    <div class="header">
        ...
        <table>
            <tr class="head">
                <td class="copy" rowspan="2">
                    <%= FrontDesk.Server.Resources.Copyrights.BBGS_HTML %>
                </td>
                <td class="score">
                    <%= ScreeningSectionID %>
                    Score
