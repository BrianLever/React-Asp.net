<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BHSReportDepressionAnswers.ascx.cs"
    Inherits="FrontDesk.Server.Web.Controls.BHSReporDepressionAnswersControl" %>
<div class="group section phq9">
    <div class="header">
        <%= _depressionScreeningResult.ScreeningSectionName %></div>
    <div class="list">
        ...
        <table>
            <tr class="head">
                <td class="copy" rowspan="2">
                    <%= FrontDesk.Server.Resources.Copyrights.PHQ9_HTML%>
                </td>
                <td class="score">
                    <%= _depressionScreeningResult.ScreeningSectionShortName %>
                    Score
                </td>
                <td class="risk">
